      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Tonyscount.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Tonyscount, accessible from{" "}
            <a
              href="https://tonyscout.vercel.app"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://tonyscout.vercel.app
            </a>
          </p>
        </li>
        <li>
