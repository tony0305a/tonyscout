                    ...
                    <S.WrapperColumn>
                        ...
                        {soloDuo ? (<S.SoloDuo>
                            ...
                            <S.SoloDuoData>
                                ...
                                <S.WinRate>
                                    <span>V {data.wins} D {data.losses}</span>
                                    <hr />
                                    <span>{Math.round((data.wins / (data.wins + data.losses)) * 100)}%  WR</span>
                                </S.WinRate>
                        ...
                        {flex ? (<S.Flex>
                            ...
                            <S.FlexData>
                                <S.EmblemAndData>
                                    ...
                                    <S.TierAndPdl>
                                        <span>{flexData.tier} {flexData.rank}</span>
                                        <span>{flexData.leaguePoints} PDLs</span>
                                    </S.TierAndPdl>
                                </S.EmblemAndData>
                                <S.WinRate>
                                    <span>V {flexData.wins} D {flexData.losses}</span>
                                    <span>{Math.round((flexData.wins / (flexData.wins + flexData.losses)) * 100)}%  WR</span>
                                </S.WinRate>
